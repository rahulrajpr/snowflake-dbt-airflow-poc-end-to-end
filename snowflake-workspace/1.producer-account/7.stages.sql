...
-->> POSTGRES - FUND MANAGERS

USE SCHEMA POSTGRES_RAW;

CREATE OR REPLACE STAGE POSTGRES_RAW.FUND_MANAGERS_STAGE
FILE_FORMAT = POSTGRES_RAW.TABLES_PARQUET_FORMAT
STORAGE_INTEGRATION = GCS_FINANCE_DATA_LANDING_STORAGE_INT
URL = 'gcs://finance-data-landing-bucket-poc/trino-extracts/fund_managers';
...
CREATE OR REPLACE STAGE POSTGRES_RAW.FUNDS_STAGE
FILE_FORMAT = POSTGRES_RAW.TABLES_PARQUET_FORMAT
STORAGE_INTEGRATION = GCS_FINANCE_DATA_LANDING_STORAGE_INT
URL = 'gcs://finance-data-landing-bucket-poc/trino-extracts/funds';
...
CREATE OR REPLACE STAGE POSTGRES_RAW.INVESTORS_STAGE
FILE_FORMAT = POSTGRES_RAW.TABLES_PARQUET_FORMAT
STORAGE_INTEGRATION = GCS_FINANCE_DATA_LANDING_STORAGE_INT
URL = 'gcs://finance-data-landing-bucket-poc/trino-extracts/investors';
...
CREATE OR REPLACE STAGE POSTGRES_RAW.TRANSACTIONS_STAGE
FILE_FORMAT = POSTGRES_RAW.TABLES_PARQUET_FORMAT
STORAGE_INTEGRATION = GCS_FINANCE_DATA_LANDING_STORAGE_INT
URL = 'gcs://finance-data-landing-bucket-poc/trino-extracts/transactions';
