...
CREATE TRANSIENT TABLE POSTGRES_RAW.INVESTORS 
	(
...
CREATE TRANSIENT TABLE POSTGRES_RAW.FUND_MANAGERS 
	(
    MANAGER_ID NUMBER,
...
CREATE TRANSIENT TABLE POSTGRES_RAW.FUNDS 
	(
...
CREATE TRANSIENT TABLE POSTGRES_RAW.ACCOUNTS 
	(
...
CREATE TRANSIENT TABLE POSTGRES_RAW.FUND_HOLDINGS 
	(
...
CREATE TRANSIENT TABLE POSTGRES_RAW.TRANSACTIONS 
	(
...
CREATE TRANSIENT TABLE POSTGRES_RAW.ACCOUNT_BALANCES 
	(
